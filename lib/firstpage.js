...
module.exports = (playlistID, options, callback, redirect) => {
  const request = HTTPS.get(redirect ? redirect : `https://www.youtube.com/playlist?list=${playlistID}&hl=en&disable_polymer=true`, { headers: options.headers }, resp => { // eslint-disable-line consistent-return, max-len
